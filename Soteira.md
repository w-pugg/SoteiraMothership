...
corporations:
  ...
  - "[[Yamaha Corp.]]"
---
**Soteira** *(named after the Greek feminine epithet meaning "Saviour", "Deliverer", or "Preserver")* is a colossal [[Ship Classes|generation-class]] vessel owned by the [[Peregrine Group]]. The vessel was initially commissioned alongside two others (**[[Ourgos]]** and [[Agrotera]]) to conduct classified large-scale long-term scientific research tasks deep in the [[far-space]] focusing on exotic extraterrestrial lifeforms. The venture was greenlit with the hopes that any technological advancements would reciprocate a competitive commercial gain and garner influence with the board of directors.

As much of a financial gargantuan Peregrine Group may be, several decades of service with incredibly little to show for it — any revelations were either profitably irrelevant, or far too dangerous to put to market — forced the administrative wing responsible for Soteira and its sister ships to begrudgingly lease large segments of each ship to its corporate allies to begin recouping losses. This transaction meant the research departments aboard each ship at the time would be required to downsize to fit in their dramatically smaller boxes. However, new, corporately distinct research teams would go on to fill the vacancy in exchange for liquid assets and research contracts.
...
>Prototype Omen Androids are designed, manufactured, and tested within Soteira’s halls. The *”Imitations”* line is the newest, seemingly near sentient design to be sent to production.
- [[Oxxen]] - *Intergalactic Freight Hauling and Logistics*
>Due to the unusual circumstances and extreme environmental patterns Soteira often finds herself in, Oxxen sees the vessel as an opportunity to stress test more situational shipping technologies. 
...
> Yamaha has an incredibly long history manufacturing affordability with excellence at the cutting edge of almost every excellency. Their Experimental Firearms Division - *EFD* for short - does not compromise. Developing in tandem with other research teams, the EFD makes sure to output the finest of novelty weaponry.
